import { ROUTES, PROTECTED_PAGES, ADMIN_ONLY_PAGES, STUDENT_ONLY_PAGES } from './router'
import type { User } from '../contexts/AuthContext'

export const getNavigationTarget = (page: string, user: User | null): string => {
...
export const getDefaultDashboard = (userRole: string): string => {
  return userRole === 'student' ? ROUTES.STUDENT_DASHBOARD : ROUTES.ADMIN_DASHBOARD
}
