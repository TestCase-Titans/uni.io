...
import { getNavigationTarget, getDefaultDashboard, shouldRedirectAfterAuth } from './utils/navigation'
...
function AppContent() {
  ...
  const shouldShowNavigation = !NO_NAVIGATION_PAGES.includes(currentPage as any)
