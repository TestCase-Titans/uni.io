...
import { ArrowLeft, Loader2, Calendar, MapPin, Users, Type } from 'lucide-react'
...
export function EventFormPage({ eventId, onNavigate }: EventFormPageProps) {
  ...
  const categories = ['Technology', 'Environment', 'Career', 'Arts', 'Sports', 'Academic', 'Social']
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.description || !formData.date || !formData.time || 
        !formData.location || !formData.category || !formData.capacity) {
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-xs text-muted-foreground">
                * Required fields. Your event will be published immediately and visible to all students.
              </p>
            </form>
          </CardContent>
        </Card>
