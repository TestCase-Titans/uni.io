...
export function SignupPage({ onNavigate }: SignupPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        onNavigate(role === 'student' ? 'student-dashboard' : 'admin-dashboard')
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className="font-bold uppercase tracking-wide text-sm">Full Name</Label>
                <Input
                  id="name"
                  type="text"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="font-bold uppercase tracking-wide text-sm">Confirm Password</Label>
                <Input
                  id="confirmPassword"
                  type="password"
              ...
              <div className="space-y-3">
                <Label className="font-bold uppercase tracking-wide text-sm">CHOOSE YOUR ADVENTURE</Label>
                <RadioGroup
                  value={role}
                ...
                >
                  <div className="relative">
                    <div className="flex items-center space-x-3 p-4 border-2 rounded-lg hover:bg-muted/50 transition-all cursor-pointer hover:border-destructive/30">
                      ...
                      <div className="flex-1">
                        <Label htmlFor="student" className="cursor-pointer font-bold">
                          STUDENT
                        </Label>
                  ...
                  <div className="relative">
                    <div className="flex items-center space-x-3 p-4 border-2 rounded-lg hover:bg-muted/50 transition-all cursor-pointer hover:border-destructive/30">
                      ...
                      <div className="flex-1">
                        <Label htmlFor="admin" className="cursor-pointer font-bold">
                          CLUB ADMIN
                        </Label>
                        <p className="text-xs text-muted-foreground font-medium">
        ...
        <div className="text-center mt-8 p-4 bg-gradient-to-r from-destructive/10 to-blue-500/10 rounded-lg border border-destructive/20">
          <p className="text-xs font-bold uppercase tracking-wide text-destructive mb-2">🎉 JOIN THE PARTY</p>
